...
# 0.0.4.6
- slope adjust effect both legs, also change slope calculation method, taken from [X-Raym](https://github.com/ReaTeam/Doc/blob/master/X-Raym_Working%20with%20Stretch%20Markers%20ReaScript%20API.md)
# 0.0.4.7
- slope adjust now keep the rate of next SM
# 0.0.4.8
- add documentation for config.lua